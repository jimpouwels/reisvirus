...
<head>
    ...
    <link rel="stylesheet" href="/static/css/styles.css?v=218">
    {if !$is_mobile_device}
        <link rel="stylesheet" href="/static/css/styles_desktop.css?v=19">
    {else}
        <link rel="stylesheet" href="/static/css/styles_mobile.css?v=25">
    {/if}
    ...
    <script src="/static/js/functions.js?v=93" type="text/javascript"></script>
