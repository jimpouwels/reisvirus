...
<head>
    ...
    {else}
        <link rel="stylesheet" href="/static/css/styles_mobile.css?v=6">
    {/if}
    ...
    <script src="/static/js/functions.js?v=40" type="text/javascript"></script>
    <script src="/static/js/menu_scripts.js?v=55" type="text/javascript"></script>
</head>
<body>
<div id="root-wrapper">
    <div id="top-wrapper">
