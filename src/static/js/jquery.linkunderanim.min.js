...
(function($){
	$.fn.linkUnderlineAnim = function(options) {
		...
		return this.each(function() {
			...
			var css = '#' + id + ' li a' + skip + ' {position: relative; text-decoration: none;}' +
				'#' + id +' li a' + skip + ':before {content: "";position: absolute; width: 100%; height: ' + o.thickness + 'px; bottom: 0; left: 0;'+
				...
				'#' + id +' li a' + skip + ':hover:before {visibility: visible; -webkit-transform: scaleX(1); transform: scaleX(1);}',
