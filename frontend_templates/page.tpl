...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="nl_NL" lang="nl_NL">
	<head>
        ...
        <link rel="stylesheet" href="/static/css/styles.css?v=140">  
        {if $is_mobile_device}
           <link rel="stylesheet" href="/static/css/styles-mobile.css?v=67">
        {/if}
        ...
        {if $is_mobile_device}
            <script src="/static/js/mobile_scripts.js?v=38" type="text/javascript"></script>
        {/if}
	</head>
	<body>
		<div id="root-wrapper">
